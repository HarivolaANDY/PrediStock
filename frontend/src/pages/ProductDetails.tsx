...
export default function ProductDetails() {
  ...
  function getSalesData() {
    switch (period) {
      case "day": return salesDataDay
      case "week": return salesDataWeek
      case "month": return salesDataMonth
      case "3months": return salesData3Months
      case "year": return salesDataYear
      case "all": return salesDataAll
      default: return salesDataMonth
    }
  }

  function getXAxisKey() {
    switch (period) {
                    ...
                    <Table className="w-full">
                      <TableHeader>
                        <tr className="bg-gray-50/50 border-b border-gray-100">
                          <th className="text-left font-semibold text-gray-700 py-4 px-6">Produit</th>
                          <th className="text-left font-semibold text-gray-700 py-4 px-6">Catégorie</th>
                          <th className="text-left font-semibold text-gray-700 py-4 px-6">Prix</th>
                          <th className="text-left font-semibold text-gray-700 py-4 px-6">Stock</th>
                          <th className="text-left font-semibold text-gray-700 py-4 px-6">Statut</th>
                          <th className="text-left font-semibold text-gray-700 py-4 px-6">Valeur totale stock</th>
                        </tr>
                      </TableHeader>
                      <TableBody>
                        {otherProducts.map((product) => (
                          ...
                          >
                            <TableCell className="py-4 px-6">
                              <div className="flex items-center gap-3">
                                <img 
                                  src={product.product_img || "/api/placeholder/40/40"} 
                                  alt={product.name}
                            ...
                            <TableCell className="py-4 px-6">{getStatusBadge(product.status)}</TableCell>
                            <TableCell className={`py-4 px-6 font-medium ${settings.darkMode ? 'text-white' : 'text-gray-900'}`}>
                              {(product.current_stock * Number(product.price)).toFixed(2)} Ar
                            </TableCell>
                            <TableCell className="py-4 px-6">
